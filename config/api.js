...
exports['default'] = {
    general: function(api) {
        ...
        return {
            ...
            // min and max ports for reverse ssh connections
            minPort: 20000,
            maxPort: 25000,
            //Redis hash key to store pairs [MAC ADDRESS, port]
            redisHash: 'sshsessions',
            authorisedKeys: process.env.AUTH_KEYS
        }
    }
};
